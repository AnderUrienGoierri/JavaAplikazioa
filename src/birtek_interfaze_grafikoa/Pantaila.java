...
public class Pantaila extends Produktua {
    ...
    public BigDecimal getHazbeteak() { return hazbeteak; }
    public void setHazbeteak(BigDecimal hazbeteak) { this.hazbeteak = hazbeteak; }

    public String getBereizmena() { return bereizmena; }
    public void setBereizmena(String bereizmena) { this.bereizmena = bereizmena; }

    public String getPanelMota() { return panelMota; }
    public void setPanelMota(String panelMota) { this.panelMota = panelMota; }

    public int getFreskatzeTasaHz() { return freskatzeTasaHz; }
    public void setFreskatzeTasaHz(int freskatzeTasaHz) { this.freskatzeTasaHz = freskatzeTasaHz; }

    public String getKonexioak() { return konexioak; }
    public void setKonexioak(String konexioak) { this.konexioak = konexioak; }

    public String getKurbatura() { return kurbatura; }
    public void setKurbatura(String kurbatura) { this.kurbatura = kurbatura; }
}
