...
public class Produktua {
    ...
    public int getIdProduktua() { return idProduktua; }
    public void setIdProduktua(int idProduktua) { this.idProduktua = idProduktua; }

    public int getHornitzaileId() { return hornitzaileId; }
    public void setHornitzaileId(int hornitzaileId) { this.hornitzaileId = hornitzaileId; }
    ...
    public void setIrudiaUrl(String irudiaUrl) { this.irudiaUrl = irudiaUrl; }

    public Integer getBiltegiId() { return biltegiId; }
    public void setBiltegiId(Integer biltegiId) { this.biltegiId = biltegiId; }

    public String getProduktuEgoera() { return produktuEgoera; }
    public void setProduktuEgoera(String produktuEgoera) { this.produktuEgoera = produktuEgoera; }

    public String getProduktuEgoeraOharra() { return produktuEgoeraOharra; }
    public void setProduktuEgoeraOharra(String produktuEgoeraOharra) { this.produktuEgoeraOharra = produktuEgoeraOharra; }

    public boolean isSalgai() { return salgai; }
    public void setSalgai(boolean salgai) { this.salgai = salgai; }

    public BigDecimal getSalmentaPrezioa() { return salmentaPrezioa; }
    public void setSalmentaPrezioa(BigDecimal salmentaPrezioa) { this.salmentaPrezioa = salmentaPrezioa; }

    public int getStock() { return stock; }
    public void setStock(int stock) { this.stock = stock; }

    public BigDecimal getEskaintza() { return eskaintza; }
    public void setEskaintza(BigDecimal eskaintza) { this.eskaintza = eskaintza; }

    public Timestamp getSortzeData() { return sortzeData; }
    public void setSortzeData(Timestamp sortzeData) { this.sortzeData = sortzeData; }
