...
public class Tableta extends Produktua {
    ...
    public String getKonektibitatea() { return konektibitatea; }
    public void setKonektibitatea(String konektibitatea) { this.konektibitatea = konektibitatea; }
    ...
    public boolean isArkatzarekinBateragarria() { return arkatzarekinBateragarria; }
    public void setArkatzarekinBateragarria(boolean arkatzarekinBateragarria) { this.arkatzarekinBateragarria = arkatzarekinBateragarria; }
}
