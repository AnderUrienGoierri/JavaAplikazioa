...
public class MenuLogistika extends JFrame {
    ...
    private void pantailaPrestatu() {
        ...
        JLabel erabiltzaileEtiketa = new JLabel(
                erabiltzaileSaila + " | " + erabiltzaileIzena + " " + erabiltzaileAbizena);
        ...
        if ("Zuzendaritza".equalsIgnoreCase(Sesioa.sailaIzena)) {
            ...
            atzeraBotoia.setFont(new Font("SansSerif", Font.BOLD, 12));
            atzeraBotoia.addActionListener(e -> {
                dispose();
                new MenuZuzendaritza().setVisible(true);
            });
            GridBagConstraints gbcAtzera = new GridBagConstraints();
            gbcAtzera.insets = new Insets(0, 10, 0, 10);
            gbcAtzera.fill = GridBagConstraints.VERTICAL;
            gbcAtzera.gridx = 3;
            gbcAtzera.gridy = 0;
            erabiltzaileInfoPanela.add(atzeraBotoia, gbcAtzera);
        }
    ...
    private void gordeSarreraOsoa() {
        ...
        try {
            ...
            pstSarrera.setInt(2, this.erabiltzaileId);
