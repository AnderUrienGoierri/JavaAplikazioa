...
public class MenuZuzendaritza extends JFrame {
    ...
    public MenuZuzendaritza(int id, String izena, String abizena, String saila) {
        ...
        adminBotoia.addActionListener(
                e -> new MenuAdministrazioa(erabiltzaileId, erabiltzaileIzena, erabiltzaileAbizena, "AdminMode")
                        .setVisible(true));

        JButton teknikariBotoia = new JButton("TEKNIKOA");
        teknikariBotoia.addActionListener(
                e -> new MenuTeknikoa(erabiltzaileId, erabiltzaileIzena, erabiltzaileAbizena, "SatMode")
                        .setVisible(true));

        JButton salmentaBotoia = new JButton("SALMENTAK");
        salmentaBotoia.addActionListener(
                e -> new MenuSalmentak(erabiltzaileId, erabiltzaileIzena, erabiltzaileAbizena, "SalesMode")
                        .setVisible(true));

        JButton logistikaBotoia = new JButton("LOGISTIKA");
        logistikaBotoia.addActionListener(
                e -> new MenuLogistika(erabiltzaileId, erabiltzaileIzena, erabiltzaileAbizena, "LogisMode")
                        .setVisible(true));
